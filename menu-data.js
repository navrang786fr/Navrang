...
var MENU_DATA = {
  "egg-curries": [
    { name: "Egg Burji", nameTe: "గుడ్డు బుర్జీ", price: 110, veg: false, thumb: "images/menu/egg-burji-100.jpg", photo: "images/menu/egg-burji-500.jpg", top: true,
      ingredients: ["Eggs", "Onion", "Tomato", "Green Chili", "Ginger-Garlic", "Turmeric", "Coriander Leaves"],
      ingredientsTe: ["గుడ్లు", "ఉల్లిపాయ", "టమాట", "పచ్చిమిర్చి", "అల్లం-వెల్లుల్లి", "పసుపు", "కొత్తిమీర"] },
  ...
  "non-veg-starter": [
    ...
    { name: "Chicken Bone Fry", nameTe: "చికెన్ బోన్ ఫ్రై", price: 180, veg: false },
    { name: "Chicken Bone Roast", nameTe: "చికెన్ బోన్ రోస్ట్", price: 200, veg: false },
    { name: "Chicken Boneless Fry", nameTe: "చికెన్ బోన్‌లెస్ ఫ్రై", price: 230, veg: false },
    ...
    { name: "Lollipop Roast", nameTe: "లాలీపాప్ రోస్ట్", price: 280, veg: false, thumb: "images/menu/lollipop-roast-100.jpg", photo: "images/menu/lollipop-roast-500.jpg" },
  ...
  "veg-curries": [
    ...
    { name: "Dal Tadka", nameTe: "దాల్ తడ్కా", price: 130, veg: true, thumb: "images/menu/dal-tadka-100.jpg", photo: "images/menu/dal-tadka-500.jpg" },
    { name: "Kaju Curry", nameTe: "కాజు కర్రీ", price: 200, veg: true },
    { name: "Kaju Paneer", nameTe: "కాజు పనీర్", price: 220, veg: true },
    { name: "Kaju Tamata", nameTe: "కాజు టమాట", price: 170, veg: true },
    { name: "Methi Chaman", nameTe: "మేథీ చమన్", price: 200, veg: true },
    { name: "Mushroom Curry", nameTe: "మష్రూమ్ కర్రీ", price: 170, veg: true },
  ...
  "veg-starters": [
    ...
    { name: "Gobi Manchuria", nameTe: "గోబీ మంచూరియా", price: 150, veg: true, thumb: "images/menu/gobi-manchuria-100.jpg", photo: "images/menu/gobi-manchuria-500.jpg" },
    { name: "Groundnut Masala", nameTe: "వేరుశనగ మసాలా", price: 140, veg: true, thumb: "images/menu/groundnut-masala-100.jpg", photo: "images/menu/groundnut-masala-500.jpg" },
    { name: "Kaju Fry", nameTe: "కాజు ఫ్రై", price: 250, veg: true },
    { name: "Kaju Roast", nameTe: "కాజు రోస్ట్", price: 250, veg: true },
    { name: "Mushroom Chili", nameTe: "మష్రూమ్ చిల్లీ", price: 190, veg: true, thumb: "images/menu/mushroom-chili-100.jpg", photo: "images/menu/mushroom-chili-500.jpg" },
    { name: "Mushroom Fry", nameTe: "మష్రూమ్ ఫ్రై", price: 170, veg: true, thumb: "images/menu/mushroom-fry-100.jpg", photo: "images/menu/mushroom-fry-500.jpg" },
    { name: "Mushroom Manchuria", nameTe: "మష్రూమ్ మంచూరియా", price: 190, veg: true },
    { name: "Mushroom Pepper", nameTe: "మష్రూమ్ పెప్పర్", price: 190, veg: true },
    { name: "Onion Pakodi", nameTe: "ఉల్లి పకోడి", price: 130, veg: true },
    { name: "Paneer 65", nameTe: "పనీర్ 65", price: 200, veg: true },
  ...
  "biryani": [
    { name: "Dum Biryani", nameTe: "దమ్ బిర్యానీ", price: 170, veg: false, top: true },
    ...
    { name: "Prawns Fry Biryani", nameTe: "రొయ్యల ఫ్రై బిర్యానీ", price: 320, veg: false },
    { name: "SP Biryani", nameTe: "SP బిర్యానీ", price: 220, veg: false }
  ],
  "roti": [
    { name: "Katak Roti", nameTe: "కటక్ రొట్టె", price: 10, veg: true },
    { name: "Patala Roti", nameTe: "పాతల రొట్టె", price: 10, veg: true },
    { name: "Ponga Roti", nameTe: "పొంగా రొట్టె", price: 12, veg: true }
  ],
  "fried-rice": [
    { name: "Chicken Rice", nameTe: "చికెన్ రైస్", price: 130, veg: false },
    { name: "Curd Rice", nameTe: "పెరుగు అన్నం", price: 80, veg: true },
    ...
    { name: "Kaju Rice", nameTe: "కాజు రైస్", price: 180, veg: true },
    { name: "Mushroom Rice", nameTe: "మష్రూమ్ రైస్", price: 150, veg: true },
    { name: "Paneer Rice", nameTe: "పనీర్ రైస్", price: 170, veg: true },
    { name: "Plain White Rice", nameTe: "ప్లెయిన్ వైట్ రైస్", price: 60, veg: true },
    { name: "Veg Rice", nameTe: "వెజ్ రైస్", price: 120, veg: true }
  ],
  "chicken-curries": [
    ...
    { name: "Kaju Chicken", nameTe: "కాజు చికెన్", price: 290, veg: false },
  ...
  "specials": [
    ...
    { name: "Kheer", nameTe: "ఖీర్", price: 50, veg: true },
